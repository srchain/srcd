...
func DefaultDataDir() string {
	...
	home := homeDir()
	if home == "" {
		return "./.silkroadchain"
	}
	switch runtime.GOOS {
	case "darwin":
		return filepath.Join(home, "Library", "SilkRoadChain")
	case "windows":
		return filepath.Join(home, "AppData", "Roaming", "SilkRoadChain")
	default:
		return filepath.Join(home, ".silkroadchain")
	}
}
