...
var runNodeCmd = &cobra.Command{
	Use:   "node",
	Short: "Run the silkroad chain daemon",
	RunE:  runNode,
}

func init() {
	runNodeCmd.Flags().String("prof_laddr", config.ProfListenAddress, "Use http to profile srcd programs")
...
func runNode(cmd *cobra.Command, args []string) error {
	...
	//new coredb,txpool,accountmanager,wallet,miner,miningpool,baseservice,p2p network
